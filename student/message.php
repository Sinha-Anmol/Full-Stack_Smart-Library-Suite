                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <form action="delall.php" method="post">
                            <!-- <button class="btn btn btn-success" type="submit" name="delete" >Delete All</button> -->
                    </form>
                            ...
                            ?>
                                    <tr>
                                     <td><?php echo $rcv ?></td>
                                      ...
                                      <td><?php echo $date ?></td>
                                      <td><?php echo $time ?></td>
                                      <td><center><form action="dele.php" method="post"><button type="submit" name="delete" class="btn btn-success">Delete</button><input type="hidden" name="M_Id" value="<?php echo $id ?>"></form></center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
                                </table>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy;  2023 Anmol Priyanka Himnish</b>All rights reserved.
            </div>
        </div>
