...
<head>
	...
	<title>UEM Library Management </title>
...
<body>
		...
		<div class="register">
			...
			<form action="index.php" method="post">
				...
				<select name="Department" id="Category" style="background-color: dimgray; opacity: 0.2;">
					<option value="Compstud">B.Tech.</option>
					<option value="Education">M.Tech.</option>
					<option value="Agriculture">BPT</option>
					 <option value="Jr.HighSchool">BBA</option>
           <option value="Sr.HighSchool">BCA</option>
			...
			<p>By creating an account, you agree to our <a class="underline" href="terms">Terms</a></p>
			<div class="clear"></div>
		</div>
	...
	<div class="footer w3layouts agileits">
		<p> &copy;  2023 Anmol Priyanka Himnish </a></p>
