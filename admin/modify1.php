                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                      ...
                                      <div class="control-group">
                                        ...
                                        <div class="control-group">
                                         ...
                                         <div class="control-group">
                                            <label class="control-label" for="status"><b>Book Quality:</b></label>
                                            <div class="controls">
                                               
                                                <select name = "status" tabindex="1" value="SC" data-placeholder="Select Status" class="span8">
                                                  <!--   <option value="<?php echo $status?>"><?php echo $status ?> </option> -->
                                                  <option value=""></option>
                                     ...
                                     <div class="control-group">
                                            <label class="control-label" for="ISBN"><b>stock left</b></label>
                                            <div class="controls">
                                                <input type="text" id="ISBN" name="stock" placeholder="ISBN" class="span8" required value="">
                                            </div >
                                        </div>

                                                <div class="control-group">
                                            <label class="control-label" for="status"><b>Book Status Update:</b></label>
                                            <div class="controls">
                                                <select name = "stat" tabindex="1" value="SC" data-placeholder="Select Status" class="span8" required>
                                                  <!--   <option value="<?php echo $status?>"><?php echo $status ?> </option> -->
                                                  <option value=""></option>
...
$stock = $_POST['stock'];
echo $sql ="INSERT INTO `stock`(`stock_left`) VALUES ('$stock')";
...
$stock = $_POST['stock'];
 ...
 $sql1="update LMS.book set `Section`='$Section',`Subject`='$subject',`Textbook`='$book',`Volume`='$Title',`Year`='$Copyright',`Availability`='$availability',`Author`='$Author',`ISBN`='$ISBN',`Status`='$status' WHERE BookId='$bookid'";


$sql ="UPDATE `stock` SET `stock_left`='stock' WHERE id = '$bookId'";


// $conn->query($sql1) or die($conn->error);

if($conn->query($sql1 AND $sql) == TRUE){
echo "<script type='text/javascript'>alert('Success')</script>";
// header( "Refresh:0.01; url=modify.php", true, 303);
}
else
{//echo $conn->error;
