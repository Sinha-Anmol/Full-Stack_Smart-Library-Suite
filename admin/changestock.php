                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <br >
                                    <form class="form-horizontal row-fluid" action="changestock.php?id=<?php echo $bookid ?>" method="post">
                                           
                                      <div class="control-group">

                                            <label class="control-label" for="Section"><b>Book Section:</b></label>
                                            <div class="controls">
                                                <select name = "Section" tabindex="1" value="SC" data-placeholder="" class="span8" readonly>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Subject" name="Subject" placeholder="Subject" class="span8" required value="<?php echo $subject?>" readonly>
                                            </div>
                                        </div>
                                         <div class="control-group">
                                            <label class="control-label" for="book"><b>Textbook</b></label>
                                            <div class="controls">
                                                <input type="text" id="book" name="book" placeholder="Textbook" class="span8" required value="<?php echo $name?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Copyright" name="Copyright" placeholder="Copyright" class="span8" required value="<?php echo $year?>" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Title"><b>Volume</b></label>
                                            <div class="controls">
                                                <input type="text" id="Title" name="Title" placeholder="Volumes" class="span8" required value="<?php echo $vol?>" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Availability"><b>Number of Copies</b></label>
                                            <div class="controls">
                                                <input type="text" id="availability" name="availability" placeholder="Number of Copies" class="span8" required value="<?php echo $avail?>" readonly>
                                            </div >
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="Author"><b>Author</b></label>
                                            <div class="controls">
                                                <input type="text" id="Author" name="Author" placeholder="Author" class="span8" required value="<?php echo $author?>" readonly>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="ISBN"><b>ISBN</b></label>
                                            <div class="controls">
                                                <input type="text" id="ISBN" name="ISBN" placeholder="ISBN" class="span8" required value="<?php echo $isbn?>" readonly>
                                            </div >
                                        </div>
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                              ...
                                              <select name = "status" tabindex="1" value="SC" data-placeholder="Select Status" class="span8" readonly>
                                                  <!--   <option value="<?php echo $status?>"><?php echo $status ?> </option> -->
                                                  <option value=""></option>
                                    ...
                                    <div class="control-group">
                                            <label class="control-label" for="stock"><b>Book Stock</b></label>
                                            <div class="controls">
                                                <input type="text" id="stock" name="stock" placeholder="Book Stock" class="span8"  value="" >
                                            </div >
                                        </div>
                                         <div class="control-group">
                                            <label class="control-label" for="stat_id"><b>Status of Book stock:</b></label>
                                            <div class="controls">
                                                 <select name = "stat_id" tabindex="1" value="SC" data-placeholder="Select Status" class="span8" required>
                                                  <!--   <option value="<?php echo $status?>"><?php echo $status ?> </option> -->
                                                  <option value=""></option>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2018 UEM Library Management System </b>All rights reserved.
            </div>
        </div>
...
$stock = $_POST['stock'];
 $bookid = $_GET['id'];
  $sql ="INSERT INTO `stock`(`id`, `stock_left`) VALUES ('$bookid','$stock')";
