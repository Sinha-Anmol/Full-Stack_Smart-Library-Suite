                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/ID No of Student" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        ...
                                        $sql="select * from LMS.user where Type<>'ADMIN' and Type<>'STAFF' and Type<>'LIBRARIAN' ";
